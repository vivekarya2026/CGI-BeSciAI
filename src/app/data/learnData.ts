...
export interface Challenge {
  ...
  category: string;
  saved?: boolean;
  /** Completion state for card variants (Completed / In progress / New) */
  completed?: boolean;
  /** Progress 0–100 for in-progress state */
  progress?: number;
...
export interface MicroLearning {
  ...
  hot?: boolean;
  completed?: boolean;
  /** 0-100, for in-progress state on card */
  progress?: number;
  contentUrl?: string;
...
export const microLearnings: MicroLearning[] = [
  ...
  { id: 'ml2', topic: 'Productivity', tool: 'ChatGPT', title: 'Meeting Agenda Generator', description: 'Generate clear agendas from a one-line topic.', duration: '4 min', points: 20, hot: true, skillLevel: 'Beginner', addedAt: '2024-02-01', progress: 45 },
  { id: 'ml3', topic: 'Prompt Engineering', tool: 'Any', title: 'Prompt Debugging 101', description: 'Fix vague or low-quality AI outputs.', duration: '7 min', points: 35, hot: true, skillLevel: 'Intermediate', addedAt: '2024-02-10', progress: 20 },
