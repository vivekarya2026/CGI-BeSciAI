...
export const STATS_TILES_CONFIG: StatStyle[] = [
  { id: 'streak', label: 'Day Streak', iconKey: 'flame', iconColor: '#f59e0b', textColor: '#b45309', badgeClass: 'badge-yellow', borderClass: 'border-[#fde68a]', borderColor: '#fde68a', tileBg: '#fef3c7', chipBg: '#fef3c7' },
  ...
  { id: 'challenges', label: 'Challenges', iconKey: 'target', iconColor: '#22c55e', textColor: '#15803d', badgeClass: 'badge-green', borderClass: 'border-[#bbf7d0]', borderColor: '#bbf7d0', tileBg: '#dcfce7' },
  { id: 'hours', label: 'Hours Learned', iconKey: 'clock', iconColor: '#8b5cf6', textColor: '#6d28d9', badgeClass: 'badge-purple', borderClass: 'border-[#ddd6fe]', borderColor: '#ddd6fe', tileBg: '#ede9fe' },
  { id: 'xp', label: 'XP', iconKey: 'star', iconColor: '#db2777', textColor: '#9d174d', badgeClass: 'badge-pink', borderClass: 'border-[#fbcfe8]', borderColor: '#fbcfe8', tileBg: '#fce7f3', chipBg: '#fce7f3' },
];
