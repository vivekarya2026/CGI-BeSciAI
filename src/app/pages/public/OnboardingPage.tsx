...
export default function OnboardingPage() {
  ...
  const canProceed = () => {
    ...
    if (step === 2) return selectedFocus.length >= 2;
          ...
          <div className="flex gap-2">
            {[1, 2, 3].map(s => (
              <div
                ...
                style={{
                  backgroundColor: s <= step ? '#5236ab' : '#e6e3f3',
                }}
              />
            ))}
          </div>
        ...
        <div className="w-full max-w-2xl">
          <AnimatePresence mode="wait">
            {step === 1 && (
              ...
              >
                <h2 style={{ fontSize: 24, fontWeight: 600, color: '#151515' }} className="mb-2 text-center">
                  Select Your Primary Goal
                </h2>
                <p style={{ fontSize: 16, color: '#5c5c5c', lineHeight: '24px' }} className="text-center mb-8">
                    ...
                    return (
                      <motion.button
                        ...
                        style={{
                          ...
                          boxShadow: isSelected ? `0 4px 16px ${goal.color}20` : '0 1px 3px rgba(0,0,0,0.04)',
                        }}
                      >
                        <div
                          className="w-12 h-12 rounded-xl flex items-center justify-center mb-4"
                          style={{ backgroundColor: `${goal.color}12`, color: goal.color }}
                        >
                          {goal.icon}
                        </div>
                        <h3 style={{ fontSize: 18, fontWeight: 600, color: '#151515' }} className="mb-1">
                          {goal.title}
                        </h3>
            ...
            {step === 2 && (
              ...
              >
                ...
                <p style={{ fontSize: 16, color: '#5c5c5c' }} className="text-center mb-8">
                  Select 2-4 areas you want to improve with AI.
                </p>
                  ...
                  {focusAreas.map((area) => {
                    ...
                    return (
                      <motion.button
                        ...
                        style={{
                          backgroundColor: isSelected ? '#5236ab' : 'white',
            ...
            {step === 3 && (
              ...
              >
                ...
                <p style={{ fontSize: 16, color: '#5c5c5c' }} className="text-center mb-10">
                  How much time can you dedicate to your AI journey?
                </p>

                {/* Timeline slider */}
                <div className="mb-10">
                  <label style={{ fontSize: 14, fontWeight: 600, color: '#151515' }} className="block mb-4">
                  ...
                  <input
                    ...
                    className="w-full accent-[#5236ab]"
                    style={{ height: 6 }}
                  />
                  ...
                  {commitments.map((c) => {
                    ...
                    return (
                      <motion.button
                        ...
                        style={{
                          borderColor: isSelected ? '#5236ab' : '#e5e7eb',
                          boxShadow: isSelected ? '0 4px 12px rgba(82,54,171,0.12)' : '0 1px 3px rgba(0,0,0,0.04)',
                        }}
                      >
